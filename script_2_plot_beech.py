...
climate_file = 'weatherGermany_era5_adjusted.txt'
...
plot_path = project_path+'graphics/sim_1_ha_1_beech_era5_adjusted.png'

cflux_data, data_climate, time = prep_climate_cflux(cflux_path, climate_path, 10)
